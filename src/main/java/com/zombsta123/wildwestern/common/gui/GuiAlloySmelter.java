package com.zombsta123.wildwestern.common.gui;
...
public class GuiAlloySmelter extends GuiContainer {
	private static final ResourceLocation TEXTURES = new ResourceLocation(
			Reference.MOD_ID + ":textures/gui/alloy_smelter.png");
	private final InventoryPlayer player;
	private final TileEntityAlloySmelter tileentity;

	public GuiAlloySmelter(InventoryPlayer player, TileEntityAlloySmelter tileentity) {
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		if (TileEntityAlloySmelter.isBurning(tileentity)) {
